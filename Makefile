...
tests: Google_tests/prqueue_tests.cpp
	g++ $(CXXFLAGS) Google_tests/prqueue_tests.cpp -lgtest -lgtest_main -lpthread -o prqueue_tests

prqueue_main: /home/jera1470/CLionProjects/CS251Project4/prqueue_main.cpp
...
solution_tests: prqueue_solution.o Google_tests/prqueue_tests.cpp
	@mv prqueue.h prqueue_student.h && mv prqueue_solution_stub.h prqueue.h
	g++ $(CXXFLAGS) prqueue_solution.o Google_tests/prqueue_tests.cpp -lgtest -lgtest_main -lpthread -o solution_tests; \
		EXIT_CODE=$$?; \
...
run: prqueue_main
	@$(WARNING)
	$(VALGRIND) /home/jera1470/CLionProjects/CS251Project4/prqueue_main
...
clean:
	rm -f prqueue_tests prqueue_main solution_tests
